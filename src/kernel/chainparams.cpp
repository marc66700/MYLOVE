...
{
    const char* pszTimestamp = "14/Feb/2026 MY LOVE : Le premier bloc d'une nouvelle ère de partage.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 14 * COIN);
